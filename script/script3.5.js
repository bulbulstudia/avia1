...
let Colors = {
  ...
  ambientLight = new THREE.AmbientLight(0XFF8844, .2);
  directionalLight = new THREE.DirectionalLight(0Xffffff);
  directionalLight.position.set(0, 0, 0);
  directionalLight.target.position.set(-115, 0, 0);
  ...
  var Pilot = function(){
    ...
    var faceMat = new THREE.MeshLambertMaterial({color:Colors.skin, shading:THREE.FlatShading});
    var face = new THREE.Mesh(faceGeom, faceMat);
    face.position.set (1, 5, 0);
    this.mesh.add(face);
  
    //hair
    var hairGeom = new THREE.BoxGeometry (4,4,4);
    var hairMat = new THREE.MeshLambertMaterial({color:Colors.brownDark, shading:THREE.FlatShading});
    ...
    hairSideR.position.set(4,-8,1);
    hairSideL.position.set(4,-8,-12);
    hairs.add(hairSideR);
    hairs.add(hairSideL);
  ...
  //ear
    var earGeom = new THREE.BoxGeometry (3,5,2);
    var earL = new THREE.Mesh (earGeom, faceMat);
  earL.position.set (0,6,-10);
  var earR = earL.clone();
  earR.position.set (0,6,10);
  this.mesh.add (earL);
  this.mesh.add (earR)
  ...
  let geomCockpit = new THREE.BoxGeometry (100,50,50,1,1,1);
  ...
  var geomTailPlane = new THREE.BoxGeometry(25,60,5,1,1,1);
  ...
  //chassis1
  var geomchsssis1 = new THREE.BoxGeometry(30,15,10,1,1,1  );
  var matchassis1 = new THREE.MeshPhongMaterial({color:Colors.blue, shading:THREE.FlatShading});
  var wheelProtecR = new THREE.Mesh(geomchsssis1, matchassis1);
  wheelProtecR.position.set(30,-20, 25);
  //chassis1.rotation.z = Math.PI/2;
  //chassis1.rotation.y = Math.PI/2;
  this.mesh.add(wheelProtecR);
  
  
  
  var wheelTireGeom = new THREE.CylinderGeometry (14,9,9,32)
  var wheelTireMat = new THREE.MeshPhongMaterial({color:Colors.brownDark, shading:THREE.FlatShading});
  var wheelTireR = new THREE.Mesh(wheelTireGeom, wheelTireMat);
  wheelTireR.rotation.x = Math.PI/2;
  wheelTireR.position.set(30,-28,25);
  
  
  var wheelAxisGeom = new THREE.BoxGeometry (8,10,6);
  ...
  for (var i=0; i<l; i++){
    ...
    this.waves.push({y:v.y,
                     ...
                     amp:5+Math.random()*40,
                     sped:0.016+Math.random()*0.032
  ...
  airplane.propeller.rotation.x+= .15
  sea.moveWaves();
  sea.mesh.rotation.z += .005;
  ...
  airplane.mesh.position.x += (targetX - airplane.mesh.position.x)*1;
  
  airplane.propeller.rotation.x += 0.07;
  }
  ...
  function createAnimatedSmoke () {
    ...
    setInterval (()=>{
      ...
      smokeMoveInterval = setInterval (()=>{
        ...
        setTimeout (() => scene.remove(smoke),1000) }, 500)
